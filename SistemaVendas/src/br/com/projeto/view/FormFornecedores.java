...
public class FormFornecedores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Painel.addTab("Consulta de Fornecedores", PainelConsultaClientes);
    ...
    private void tbConsultaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbConsultaMouseClicked
        ...
        txtComplemento.setText(""); 
         ...
         txtCnpj.setText(String.valueOf(tbConsulta.getValueAt(tbConsulta.getSelectedRow(), 2)));
         txtEmail.setText(String.valueOf(tbConsulta.getValueAt(tbConsulta.getSelectedRow(), 3)));
         txtTelefone.setText(String.valueOf(tbConsulta.getValueAt(tbConsulta.getSelectedRow(), 4)));
         txtCelular.setText(String.valueOf(tbConsulta.getValueAt(tbConsulta.getSelectedRow(), 5)));
         txtCep.setText(String.valueOf(tbConsulta.getValueAt(tbConsulta.getSelectedRow(), 6)));
         txtEndereco.setText(String.valueOf(tbConsulta.getValueAt(tbConsulta.getSelectedRow(), 7)));
         txtNumero.setText(String.valueOf(tbConsulta.getValueAt(tbConsulta.getSelectedRow(), 8)));
         txtComplemento.setText(String.valueOf(tbConsulta.getValueAt(tbConsulta.getSelectedRow(), 9)));
         txtBairro.setText(String.valueOf(tbConsulta.getValueAt(tbConsulta.getSelectedRow(), 10)));
         txtCidade.setText(String.valueOf(tbConsulta.getValueAt(tbConsulta.getSelectedRow(), 11)));
         cbUf.setSelectedItem(String.valueOf(tbConsulta.getValueAt(tbConsulta.getSelectedRow(), 12)));

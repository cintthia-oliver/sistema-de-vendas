...
public class FormFuncionario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tbConsulta.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome", "RG", "CPF", "E-mail", "Senha", "Cargo", "Nivel de Acesso", "Telefone", "Celular", "CEP", "Endereço", "Nº", "Compl.", "Bairro", "Cidade", "UF"
            }
        ));
        ...
        Painel.addTab("Consulta de Funcionários", PainelConsultaClientes);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(Painel, javax.swing.GroupLayout.PREFERRED_SIZE, 325, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void tbConsultaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbConsultaMouseClicked
        ...
        txtComplemento.setText("");
         ...
         txtSenha.setText(String.valueOf(tbConsulta.getValueAt(tbConsulta.getSelectedRow(), 5)));
         txtCargo.setText(String.valueOf(tbConsulta.getValueAt(tbConsulta.getSelectedRow(), 6)));
         cbNivel.setSelectedItem(String.valueOf(tbConsulta.getValueAt(tbConsulta.getSelectedRow(), 7)));
         txtTelefone.setText(String.valueOf(tbConsulta.getValueAt(tbConsulta.getSelectedRow(), 8)));
         txtCelular.setText(String.valueOf(tbConsulta.getValueAt(tbConsulta.getSelectedRow(), 9)));
         txtCep.setText(String.valueOf(tbConsulta.getValueAt(tbConsulta.getSelectedRow(), 10)));
         txtEndereco.setText(String.valueOf(tbConsulta.getValueAt(tbConsulta.getSelectedRow(), 11)));
         txtNumero.setText(String.valueOf(tbConsulta.getValueAt(tbConsulta.getSelectedRow(), 12)));
         txtComplemento.setText(String.valueOf(tbConsulta.getValueAt(tbConsulta.getSelectedRow(), 13)));
         txtBairro.setText(String.valueOf(tbConsulta.getValueAt(tbConsulta.getSelectedRow(), 14)));
         txtCidade.setText(String.valueOf(tbConsulta.getValueAt(tbConsulta.getSelectedRow(), 15)));
         cbUf.setSelectedItem(String.valueOf(tbConsulta.getValueAt(tbConsulta.getSelectedRow(), 16)));
